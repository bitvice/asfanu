...
export async function createRegistrationAction(rawValues: RegistrationFormValues) {
  ...
  const { data: reg, error: regError } = await supabase
    ...
    .insert({
      ...
      has_large_family_certificate: values.has_large_family_certificate,
      large_family_certificate_number: values.has_large_family_certificate ? values.large_family_certificate_number?.trim() || null : null,
      large_family_certificate_issued_at: values.has_large_family_certificate ? values.large_family_certificate_issued_at || null : null,
